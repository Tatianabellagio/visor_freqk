...
# SV_TYPE=DEL  COVERAGE=10  SV_FREQ=0.7  N_SAMPLES=231
# ERROR_RATE=0.001  K=31  POS=14725000  POS_LABEL=pos14725000
...
SV_TYPE="DEL"
CHROM="Chr1"
SV_START_0=14725000      # BED 0-based start
ANCHOR_POS=14724999       # one base before deletion (VCF POS, 1-based)
POS_LABEL="pos14725000"
