...
# SV_TYPE=DEL  COVERAGE=50  SV_FREQ=0.5  N_SAMPLES=231
# ERROR_RATE=0.001  K=31  POS=14960000  POS_LABEL=pos14960000
...
SV_TYPE="DEL"
CHROM="Chr1"
SV_START_0=14960000      # BED 0-based start
ANCHOR_POS=14959999       # one base before deletion (VCF POS, 1-based)
POS_LABEL="pos14960000"
